...
class PeriodChangeButton extends StatelessWidget {
  PeriodChangeButton({super.key});
    ...
    return Obx(() {
      return Center(
        child: AnimatedToggleSwitch<int>.size(
          current: mapController.getSelectedPeriod(),
          style: ToggleStyle(
          ...
          customIconBuilder: (context, local, global) {
            final text = const ['전체', '이번주', '오늘'][local.index];
            return Center(
              child: Text(
                text,
                style: TextStyle(
